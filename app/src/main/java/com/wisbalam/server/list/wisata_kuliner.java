...
public class wisata_kuliner extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtnama.setText("Wisata Kuliner Menurut Kamus Besar Bahasa Indonesia Adalah Perjalan Yang Memanfaatkan Massakan Serta Suasana Lingkungannya Sebagai Objek Tujuan Wisata");
        ...
        adapter=new recycler_semua_wisata(dataItem,wisata_kuliner.this);
        ...
        adapter.setOnItemClickListener(new recycler_semua_wisata.OnItemClickListener() {
            ...
            //   Toast.makeText(semua_wisata.this, list_namabarang.get(position) + " id_toko " + id_toko +" id user "
             ...
             //   Toast.makeText(semua_wisata.this, list_idwisata.get(position), Toast.LENGTH_SHORT).show();
               Intent godata = new Intent(wisata_kuliner.this, detail_wisata.class);
    ...
    public void viewdata(String search){
        try {
            ...
            arraydata = new JSONArray(dbActivity.wisata_kuliner(search));
