...
public class semua_wisata extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtnama.setText("Wisata Bahari / Laut Menurut Kamus Besar Bahasa Indonesia Adalah Berpergian Menikmati Alam Laut");
        ...
        adapter=new recycler_semua_wisata(dataItem,semua_wisata.this);
        ...
        adapter.setOnItemClickListener(new recycler_semua_wisata.OnItemClickListener() {
            ...
            //   Toast.makeText(semua_wisata.this, list_namabarang.get(position) + " id_toko " + id_toko +" id user "
             ...
             //   Toast.makeText(semua_wisata.this, list_idwisata.get(position), Toast.LENGTH_SHORT).show();
               Intent godata = new Intent(semua_wisata.this, detail_wisata.class);
    ...
    public void viewdata(String search){
        try {
            ...
            arraydata = new JSONArray(dbActivity.view_wisata(search));
