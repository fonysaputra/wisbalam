...
public class wisata_sejarah extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtnama.setText("Wisata Sejarah Dan Religi Adalah Aktivitas Perjalan Wisata Dengan Mengunjungi Berbagai Peninggalan Sejarah, Situs Sejarah," +
                "Tempat Ibadah Khusus Umat Beragama, Makam Dan Museum  ");
        ...
        adapter=new recycler_semua_wisata(dataItem,wisata_sejarah.this);
        ...
        adapter.setOnItemClickListener(new recycler_semua_wisata.OnItemClickListener() {
            ...
            //   Toast.makeText(semua_wisata.this, list_namabarang.get(position) + " id_toko " + id_toko +" id user "
             ...
             //   Toast.makeText(semua_wisata.this, list_idwisata.get(position), Toast.LENGTH_SHORT).show();
               Intent godata = new Intent(wisata_sejarah.this, detail_wisata.class);
    ...
    public void viewdata(String search){
        try {
            ...
            arraydata = new JSONArray(dbActivity.wisata_sejarah(search));
