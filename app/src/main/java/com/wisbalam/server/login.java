            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        // Toast.makeText(Login.this, "stat = " +status_user , Toast.LENGTH_SHORT).show();
                       ...
                       // System.out.println("test = " + id);
                        if(level.equals("user")) {
                            ...
                            finish();
                           // Toast.makeText(login.this, TAG_ID, Toast.LENGTH_SHORT).show();
                            startActivity(intent);
                             ...
                             Toast.makeText(login.this, "Status Salah"+ level, Toast.LENGTH_SHORT).show();
                        }
